...
/***/ "./src/app/add-new-dishes/add-dishes.component.css":
/*!*********************************************************!*\
  !*** ./src/app/add-new-dishes/add-dishes.component.css ***!
  \*********************************************************/
/*! no static exports found */
...
/***/ "./src/app/add-new-dishes/add-dishes.component.html":
/*!**********************************************************!*\
  !*** ./src/app/add-new-dishes/add-dishes.component.html ***!
  \**********************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"row\">\n  <form>\n    <div class=\"input-field col s3\">\n      <input id=\"first_name_1\" type=\"text\" required [formControl]=\"categoryesControl.get('category')\"  class=\"validate\">\n      <label class=\"active\" for=\"first_name_1\">Категорія</label>\n    </div>\n    <div class=\"input-field col s3\">\n      <input id=\"first_name_2\" type=\"text\" required [formControl]=\"categoryesControl.get('name')\"   class=\"validate\">\n      <label class=\"active\" for=\"first_name_2\">Назва</label>\n    </div>\n    <div class=\"input-field col s3\">\n      <input id=\"first_name_3\" type=\"text\"  required [formControl]=\"categoryesControl.get('price')\"  class=\"validate\">\n      <label class=\"active\" for=\"first_name_3\">Ціна</label>\n    </div>\n\n\n    <button class=\"btn waves-effect waves-light\" routerLink=\"/home\" (click)=\"addDishes()\" type=\"submit\" name=\"action\">save\n    </button>\n  </form>\n\n</div>"

/***/ }),

/***/ "./src/app/add-new-dishes/add-dishes.component.ts":
/*!********************************************************!*\
  !*** ./src/app/add-new-dishes/add-dishes.component.ts ***!
  \********************************************************/
...
/* harmony import */ var _dishes_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../dishes.service */ "./src/app/dishes.service.ts");
...
var AddDishesComponent = /** @class */ (function () {
    function AddDishesComponent(fb, dishesServise) {
        this.fb = fb;
        this.dishesServise = dishesServise;
        this.title = 'app';
        this.aDishes = false;
    }
    AddDishesComponent.prototype.addDishes = function () {
        this.aDishes = true;
    ...
    AddDishesComponent.prototype.ngOnInit = function () {
        ...
        this.categoryesControl.valueChanges.subscribe(function (value) { return console.log(value); });
    };
    AddDishesComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-add-dishes',
            template: __webpack_require__(/*! ./add-dishes.component.html */ "./src/app/add-new-dishes/add-dishes.component.html"),
            styles: [__webpack_require__(/*! ./add-dishes.component.css */ "./src/app/add-new-dishes/add-dishes.component.css")]
        }),
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], _dishes_service__WEBPACK_IMPORTED_MODULE_2__["DishesService"]])
    ], AddDishesComponent);
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [_dishes_service__WEBPACK_IMPORTED_MODULE_1__["DishesService"]]
        })
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _add_new_dishes_add_dishes_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./add-new-dishes/add-dishes.component */ "./src/app/add-new-dishes/add-dishes.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    { path: 'addNewDishe', component: _add_new_dishes_add_dishes_component__WEBPACK_IMPORTED_MODULE_14__["AddDishesComponent"] },
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _add_new_dishes_add_dishes_component__WEBPACK_IMPORTED_MODULE_14__["AddDishesComponent"],
            ],
            imports: [
...
module.exports = "<div class=\"row\">\r\n    <div class=\"col s2\">\r\n        <p>Загальна сума {{sumDishes()}}  грн</p>\r\n    </div>\r\n\r\n</div>\r\n<app-dish *ngFor=\"let dish of basketServise.BasketList\" [isBasketDish]=\"true\" [dishes]=\"dish\"></app-dish>"
...
var BasketPageComponent = /** @class */ (function () {
    ...
    BasketPageComponent.prototype.sumDishes = function () {
...
var DishesService = /** @class */ (function () {
    ...
    DishesService.prototype.getDishes = function () {
        ...
        if (this.dishes.length == 0)
            return this.http.get("assets/API/menu.json").pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (response) { return _this.dishes = response; }));
        else {
            return Object(rxjs_index__WEBPACK_IMPORTED_MODULE_3__["of"])(this.dishes);
        }
    };
...
var UserComponent = /** @class */ (function () {
    ...
    UserComponent.prototype.remoteBuy = function () {
        ...
        this.deleteBuy = false;
        this.isMarke = false;
        this.basketServise.BasketList = this.basketServise.BasketList.filter(function (x) { return x != _this.dishes; });
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], UserComponent.prototype, "dishes", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
...
module.exports = "\n\n<div class=\"row\">\n  <div class=\"input-field col s6\">\n    <input id=\"first_name\" type=\"text\" class=\"validate\"[(ngModel)]=\"serchStr\">\n    <label class=\"active\" for=\"first_name\">search by name</label>\n  </div>\n  <div class=\"col s3\" >\n    <a routerLink=\"/addNewDishe\" class=\"waves-effect waves-light btn remote\">Добавити страву</a>\n  </div>\n  <div class=\"col s3\" >\n    <a routerLink=\"/basket\" class=\"waves-effect waves-light btn remote\">Корзина</a>\n  </div>\n</div>\n<div class=\"row\">\n  <app-dish\n          *ngFor = \" let u of dish | search:serchStr\"\n          [dishes]=\"u\">\n  </app-dish>\n</div>"
...
var HomePageComponent = /** @class */ (function () {
    function HomePageComponent(dishesServise, activated) {
        var _this = this;
        this.dishesServise = dishesServise;
    ...
    HomePageComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_dishes_service__WEBPACK_IMPORTED_MODULE_1__["DishesService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]])
    ], HomePageComponent);
